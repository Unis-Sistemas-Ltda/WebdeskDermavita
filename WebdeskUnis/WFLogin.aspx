<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WFLogin.aspx.vb" Inherits="WebdeskUnis.WFLogin" %>
...
<body>
    ...
    <table style="width: 100%;" class="TextoCadastro">
        <tr>
            <td align="center" style="background-color: #FFFFFF">
                ...
                <br />
                <img 
                    alt="" src="Imagens/logo-cliente.png" style="height: 87px; width: 404px" /></td>
        </tr>
        <tr>
            <td align="center" 
        ...
        <tr class="Titulo2">
            <td>
                <b>ACESSO EXCLUSIVO PARA CLIENTES</b></td>
        </tr>
        <tr>
            <td class="TextoCadastro">
                <hr />
        ...
        <tr>
            ...
            &nbsp;<asp:Label ID="Label1" runat="server" Font-Italic="False" ForeColor="#4D8C80" style="text-align:left"
                    Height="17px" Text="Informe seu CNPJ ou endereço de e-mail" Width="261px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
        ...
        <tr>
            <td style="text-align: center">
                ...
                &nbsp;<asp:LinkButton ID="BtnEsqueciMinhaSenha" runat="server" Width="200px" 
                    style="text-align: left" Font-Size="7pt">Esqueci minha senha<br>
	...
	<tr>
	    <td style="text-align: center;">
            <br><b>Dermavita Industria Cosmética</b><br>AV. DOM JOAQUIM, 45, 88354-025 - BRUSQUE SC<br><b>(47) 3355-5519</b><br><br />
	    </td>
	</tr>
        </table>
